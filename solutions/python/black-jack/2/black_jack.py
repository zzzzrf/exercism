...
def higher_card(card_one, card_two):
    ...
    va = value_of_card(card_one)
    vb = value_of_card(card_two)
    if va == vb:
        return card_one, card_two
    return card_two if va < vb else card_one
...
def value_of_ace(card_one, card_two):
    ...
    return 11 if (3 < (value_of_card(card_one) + value_of_card(card_two)) < 11) else 1
...
def can_double_down(card_one, card_two):
    ...
    return True if sum_value in {9, 10, 11} else False
